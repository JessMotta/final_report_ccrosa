...
Como resultado obtido desse projeto é possível ver nas Figuras \ref{fig:ambiente_saci}, \ref{fig:warthog_simulacao} e \ref{fig:warthog_desafio_3}, respectivamente, o ambiente externo modelado na simulação, o robô no ambiente de simulação e este no ambiente real. No link \url{https://github.com/Brazilian-Institute-of-Robotics/wbm_ekfslam} está o repositório com os códigos do projeto. E no Apêndice \ref{append:saci} está inserido o relatório gerado para esse projeto.
