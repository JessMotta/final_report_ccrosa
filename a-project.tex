...
% -------------------------------------------------------------------------------
% Informações gerais
    \thesistitle{Relatório Final do Curso de Formação em Robótica e Sistemas Autônomos}
    \hidevolume
...
% Include thesis appendices
    \begin{thesisappendices}
        ...
        \includepdf[pages={1-75}]{Appendices/relatorio_saci.pdf}
        \includepdf[pages={1-9}]{Appendices/analise_estatistica_darwinop.pdf}
